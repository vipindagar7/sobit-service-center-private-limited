...
const features = [
    {
        ...
        href: "/services",
        cta: "Explore Now",
        background: <img src="/images/digital-services.jpg" alt="Digital Services" className="absolute -right-20 -top-20 opacity-60" />,
    ...
    },
    {
        ...
        href: "/services",
        cta: "View Listings",
        background: <img src="/images/real-estate.jpg" alt="Real Estate Services" className="absolute -right-20 -top-20 opacity-60" />,
    ...
    },
    {
        ...
        href: "/services",
        cta: "Get Started",
        background: <img src="/images/financial-services.jpg" alt="Financial Services" className="absolute -right-20 -top-20 opacity-60" />,
    ...
    },
    {
        ...
        href: "/services",
        cta: "Shop Now",
        background: <img src="/images/fmcg.jpg" alt="FMCG Services" className="absolute -right-20 -top-20 opacity-60" />,
    ...
    },
    {
        ...
        background: <img src="/images/consulting.jpg" alt="Consulting Services" className="absolute -right-20 -top-20 opacity-60" />,
